    ...
    return (
        <div className='max-w-7xl mx-auto my-10 px-4 sm:px-6 lg:px-0'>
            ...
            <div className='my-4 space-y-2 text-sm sm:text-base'>
                ...
                <h1 className='font-bold'>Description: <span className='pl-2 font-normal text-gray-800'>{singleJob?.description}</span></h1>
                <h1 className='font-bold'>Experience: <span className='pl-2 font-normal text-gray-800'>{singleJob?.experience} yrs</span></h1>
