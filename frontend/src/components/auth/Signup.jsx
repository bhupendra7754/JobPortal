        ...
        <div>
            ...
            <div className='flex items-center justify-center max-w-7xl mx-auto px-4'>
                <form
                    ...
                    className='w-full sm:w-[90%] md:w-[70%] lg:w-[60%] xl:w-[50%]
                               border border-gray-200 rounded-md p-4 sm:p-6 my-10'
                >
...

                    {
                        loading ? (
                            ...
                            <Button type="submit" className="w-full h-11 sm:h-12 my-4">
                                Signup
                            </Button>
                        )
                    }
